...
def post(url, data, proxy_handler):
    ...
    opener.addheaders.append(('Host',
                              '/joinnew/processjq.ashx?curid=' + curid + '&starttime=2018%2F3%2F30%2011%3A36%3A52&source=directphone&submittype=1&rn=1919210476&lct=49&t=1522381021549'))
    ...
    opener.addheaders.append(('X-Forwarded-For',
                              str(random.randint(1, 255)) + '.' + str(random.randint(1, 255)) + '.' + str(
    ...
    while 1:
        try:
            dict = [[random_index([1, 1, 0, 0, 0, 0, 0])],
                    ...
                    [random_index([0, 0, 0, 0, 3, 3, 2]), random_index([0, 0, 0, 1, 3, 3, 2]),
                     random_index([0, 0, 0, 2, 3, 3, 2]), random_index([0, 0, 0, 1, 3, 3, 1])],
                    [random_index([0, 0, 0, 1, 3, 3, 2]), random_index([0, 0, 0, 2, 3, 3, 2]),
                     random_index([0, 0, 0, 1, 3, 3, 2]), random_index([0, 0, 1, 1, 3, 3, 1])],
                    [random_index([0, 0, 0, 0, 2, 3, 3]), random_index([0, 0, 0, 0, 0, 2, 3]),
                     random_index([0, 0, 0, 1, 3, 3, 1]), random_index([0, 0, 0, 0, 1, 1, 1])],
                    [random_index([0, 0, 0, 0, 0, 3, 3]), random_index([0, 0, 0, 0, 0, 3, 3]),
                     random_index([0, 0, 0, 0, 0, 3, 3]), random_index([0, 0, 0, 0, 0, 2, 3]),
                     random_index([0, 0, 0, 0, 1, 1, 1]), random_index([0, 0, 0, 1, 3, 3, 1]),
                     random_index([0, 0, 0, 0, 3, 3, 1]), random_index([0, 0, 0, 0, 0, 1, 1]),
                     random_index([0, 0, 0, 2, 3, 3, 1])]]
